			...
			<form class="et_install-demo-form with-scroll" action="">
				...
				<div class="et_manual-setup">
                    ...
                    if ( isset( $to_import['elementor_sections'] ) && ! empty( $to_import['elementor_sections'] ) ): ?>
                        <input class="et-mb-remove" type="checkbox" id="elementor_sections" name="elementor_sections" value="elementor_sections" checked>
                        <label class="et-mb-remove" for="elementor_sections"><?php echo esc_html__('Elementor sections', 'xstore'); ?></label>
