...
//			    }
    ...
    public function enqueue_scripts() {
    	...
    	// @todo empty file to remove but make correct localize for all scripts depends on it
        wp_enqueue_script(
	    ...
	    $localize = array(
		    ...
		    'search' => array(
			    'noResults'               => esc_html__( 'No results were found!', 'xstore-core' ),
			    'product' 				 => esc_html__('Products', 'xstore-core'),
			    'page' 				 => esc_html__('Pages', 'xstore-core'),
			    'post' 					 => esc_html__('Posts', 'xstore-core'),
			    'etheme_portfolio' 			 => esc_html__('Portfolio', 'xstore-core'),
			    'product_found' => esc_html__('{{count}} Products found', 'xstore-core'),
			    'page_found' => esc_html__('{{count}} Pages found', 'xstore-core'),
			    'post_found' => esc_html__('{{count}} Posts found', 'xstore-core'),
			    'etheme_portfolio_found' => esc_html__('{{count}} Portfolio found', 'xstore-core'),
			    'custom_post_type_found' => esc_html__('{{count}} {{post_type}} found', 'xstore-core'),
			    'show_more' => esc_html__('Show {{count}} more', 'xstore-core'),
			    'show_all' => esc_html__('View all results', 'xstore-core'),
			    'items_found' => esc_html__('{{count}} items found', 'xstore-core'),
			    'item_found' => esc_html__('{{count}} item found', 'xstore-core'),
...
//			    'fancy_select_categories' => get_theme_mod('search_category_fancy_select_et-desktop', false), //
	    ...
	    $localize['search']['noSuggestionNoticeWithMatches'] = $localize['search']['noResults'] . '<p>' . __( 'No items matched your search {{search_value}}.', 'xstore-core' ) . '</p>';
	    $localize['lottie']['defaultAnimationUrl'] = ET_CORE_URL . 'app/assets/js/lottie-default.json';
