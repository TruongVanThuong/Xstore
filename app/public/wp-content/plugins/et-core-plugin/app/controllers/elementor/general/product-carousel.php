...
//			return;
		...
		foreach (self::get_product_elements() as $key => $string_text) {
		    ...
		    switch ($key) {
                ...
                default:
                    ob_start();
                    do_action('etheme_product_grid_list_product_element_render', $key, $product, $edit_mode);
                 ...
                 if ( $local_settings['hover_effect'] != 'disable' ) {
	                 ...
	                 foreach (self::get_product_hover_elements() as $key => $string_text) {
	                    ...
	                    switch ($key) {
		                    ...
		                    default:
			                    ob_start();
			                    do_action('etheme_product_grid_list_product_hover_element_render', $key, $product, $edit_mode);
			                    $get_action_content = ob_get_clean();
			                    if ( $get_action_content != '') {
