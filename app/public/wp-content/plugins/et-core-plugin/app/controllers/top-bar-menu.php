    ...
    public function top_bar_menu( $wp_admin_bar ){
        ...
        if ( in_array('customize', $this->settings->show_pages) ) {
            ...
            if ( $this->is_woocommerce ) {
                ...
                if ( in_array( 'email_builder', $this->settings->show_pages ) ) {
                    $wp_admin_bar->add_node( array(
                        ...
                        'title'  => esc_html__( 'Built-in Email Builder', 'xstore-core' ). $this->label()->hot,
	        ...
	        $wp_admin_bar->add_node( array(
		        ...
		        'title'  => esc_html__( 'Sales Booster', 'xstore-core' ) . $this->label()->new,
		        'href'   => admin_url( 'admin.php?page=et-panel-sales-booster' ),
	        ) );
	        ...
	        $wp_admin_bar->add_node( array(
		        ...
		        'href'   => esc_url('https://xstore.helpscoutdocs.com/'),
		        'meta' => array(
		        	'target' => '_blank'
		        )
	        ) );
...
//			}
    ...
    private function style(){
        ...
        .et_adm-mega-menu-holder.opened .loaded:after{
            right: 0;
