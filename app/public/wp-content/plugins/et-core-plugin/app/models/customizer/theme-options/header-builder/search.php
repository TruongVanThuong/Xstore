...
add_filter( 'et/customizer/add/fields/search', function ( $fields ) use ( $separators, $strings, $choices, $sep_style, $sidebars_with_inherit, $post_types, $box_models ) {
	...
	$args = array(
		...
		'search_staticblock'                              => array(
			...
			'label'           => sprintf( esc_html__( 'Choose %1s for search extra content', 'xstore-core' ), '<a href="https://xstore.helpscoutdocs.com/article/47-static-blocks" target="_blank" style="color: #555">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
			'section'         => 'search',
			'default'         => '',
			'priority'        => 10,
