                            ...
                            <div class="product-item-right" data-row-id="<?php esc_attr_e( $item['prod_id'] ); ?>">
								...
								<?php if ( $add_remove_ajax ) : ?>
                                    <a href="<?php echo add_query_arg( 'remove_from_wishlist', $item['prod_id'], esc_url( YITH_WCWL()->get_wishlist_url() ) ); ?>"
                                       ...
                                       title="<?php echo esc_attr( 'Remove this product', 'xstore-core' ); ?>"><i
                                                ...
                                                class="et-trash-wrap et-remove-type2"><img
                                                    ...
                                                    alt="<?php echo esc_attr( 'Remove this product', 'xstore-core' ); ?>"></i></a>
								<?php endif; ?>
...
if ( ! function_exists( 'et_age_verify_anchor' ) ) {
	function et_age_verify_anchor() {
		...
		if ( !get_query_var('et_is_customize_preview', false) && isset( $_COOKIE['age_verify_popup_shows'] ) && $_COOKIE['age_verify_popup_shows'] == 'false' ) {
			return;
		}
