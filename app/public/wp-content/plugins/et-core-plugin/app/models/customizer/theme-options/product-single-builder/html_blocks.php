...
add_filter( 'et/customizer/add/fields/single_product_html_blocks', function ( $fields ) use ( $post_types, $strings, $sep_style ) {
	...
	$args = array(
		...
		'single_product_html_block4_section'           => array(
			...
			'label'           => sprintf( esc_html__( 'Choose %1s for Html block 4', 'xstore-core' ), '<a href="https://xstore.helpscoutdocs.com/article/47-static-blocks" target="_blank" style="color: #555">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
			'section'         => 'single_product_html_blocks',
			'default'         => '',
			'choices'         => $post_types['sections'],
			'active_callback' => array(
		...
		'single_product_html_block5_section'           => array(
			...
			'label'           => sprintf( esc_html__( 'Choose %1s for Html block 5', 'xstore-core' ), '<a href="https://xstore.helpscoutdocs.com/article/47-static-blocks" target="_blank" style="color: #555">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
			'section'         => 'single_product_html_blocks',
			'default'         => '',
			'choices'         => $post_types['sections'],
			'active_callback' => array(
