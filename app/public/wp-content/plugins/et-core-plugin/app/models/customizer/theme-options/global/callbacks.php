        ...
        <div class="et-content">
            ...
            <div class="button-wrapper">
	            <?php if ( $element_options['agree_button_text'] != '' ) : ?>
                    <a class="btn medium active et-close-popup close-forever et-age-verified"><?php echo $element_options['agree_button_text']; ?></a>
	            <?php endif; ?>
...
//                    if ( is_cart() ) {
			...
			case 'wishlist':
				...
				if ( $mob_panel_element_options['is_YITH_WCWL'] && function_exists( 'yith_wcwl_is_wishlist_page' ) && yith_wcwl_is_wishlist_page() ) {
					$mob_panel_element_options['class'] .= 'active';
				}
				break;
