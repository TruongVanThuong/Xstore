...
add_filter( 'et/customizer/add/sections', function ( $sections ) {
	...
	$args = array(
		'age_verify_popup' => array(
			...
			'title'      => esc_html__( 'Age Verify Popup', 'xstore' ),
			'icon'       => 'dashicons-lock',
			'priority'   => 7,
			'type'       => 'kirki-lazy',
			'dependency' => array()
...
add_filter( 'et/customizer/add/fields/age_verify_popup', function ( $fields ) use ( $separators, $strings, $choices, $sep_style, $is_rtl, $post_types ) {
	$args = array();
