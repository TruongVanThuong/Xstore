...
add_filter( 'et/customizer/add/fields/cart-checkout-layout', function ( $fields ) use ( $sep_style, $strings, $post_types, $box_models, $choices ) {
	$args = array();
	...
	$args = array(
		...
		'cart_checkout_footer_content_section'       => array(
			...
			'label'           => sprintf( esc_html__( 'Choose %1s for Footer content', 'xstore-core' ), '<a href="https://xstore.helpscoutdocs.com/article/47-static-blocks" target="_blank" style="color: #555">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
			'section'         => 'cart-checkout-layout',
			'default'         => '',
			'priority'        => 10,
