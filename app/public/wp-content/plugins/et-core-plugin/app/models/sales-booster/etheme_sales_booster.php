	...
	class Etheme_Sales_Booster_Backend {
		...
		public function sales_booster_page() {
            ...
            <p class="et-message et-info">
				<?php echo '<strong>' . esc_html__( 'Welcome to the Sales Booster panel!', 'xstore-core' ) . '</strong> &#127881'; ?><br/>
            ...
            <div class="et-tabs-filters-wrapper">
                ...
                <ul class="et-filters et-tabs-filters">
                    ...
                    <li class="<?php echo 'estimated_delivery' == $active_tab ? 'active' : ''; ?>"
                        data-tab="estimated_delivery"><?php echo esc_html__( 'Estimated Delivery (beta)', 'xstore-core' ); ?></li>
                    ...
                    <form class="xstore-panel-settings" method="post"
                        ...
                        <div class="xstore-panel-settings-inner">
							...
							<?php $this->global_admin_class->xstore_panel_settings_input_text_field( $tab_content,
								...
								__( 'More examples of formats types <a href="https://www.php.net/manual/en/function.strftime.php" target="_blank">on this page</a>. Default format is inherited from your  <a href="' . admin_url( 'options-general.php' ) . '" target="_blank">WordPress settings</a>', 'xstore-core' ),
								sprintf(
                    ...
                    <form class="xstore-panel-settings" method="post"
                        ...
                        <div class="xstore-panel-settings-inner">
							...
							$this->global_admin_class->xstore_panel_settings_switcher_field( $tab_content,
								...
								esc_html__( 'Turn on if it is required to upload images on new review', 'xstore' ),
								false );
							
//							$this->global_admin_class->xstore_panel_settings_switcher_field( $tab_content,
//								'images_lightbox',
//								esc_html__( 'Images Lightbox', 'xstore-core' ),
//								esc_html__( 'Turn on to open lightbox on image click in comments', 'xstore' ),
//								true );
							
							$this->global_admin_class->xstore_panel_settings_switcher_field( $tab_content,
								'images_preview',
								esc_html__( 'Images Preview', 'xstore-core' ),
								esc_html__( 'Turn on to show customer preview images before submitting form', 'xstore' ),
								true );
							?>
